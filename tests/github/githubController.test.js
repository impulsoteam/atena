...
// import interaction from '../../controllers/interaction'
...
// const link_auth = `https://github.com/login/oauth/authorize?scope=user:email&client_id=${process.env.GITHUB_CLIENT_ID}`
