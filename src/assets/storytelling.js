...
export const generateStorytelling = ({ level, username }) => {
  const storytelling = {
    levelOne: `Que bom ter você por aqui, @${username}! :blush: Estou muito feliz por você fazer parte da Impulso Network!
    ...
    Embora meu dia a dia seja super tecnológico, às vezes, tem tanta informação nesse mundo da tecnologia que parece que todos estão falando grego!:joy:
    ...
    Diversas das suas atividades aqui na Impulso Network serão premiadas com *Pontos de Reputação!* Esses pontos, junto com outras tarefas, permitirão que você alcance *novos níveis* dentro da Impulso Network. :sports_medal:
    ...
    Por hora, vou ter dar sua *primeira missão* :dart: com as seguintes etapas:
    ...
    Na hora certa, voltarei a falar com você! Espero por notícias suas! :smile:
    Uau, parabéns! :tada: Você acaba de alcançar o *Nível Ferro*;
    *Com isso, você ganhou:* livre acesso ao chat da rede de comunidades da Impulso Network, possibilidade de participar e criar meetups, talks, lives e eventos na rede, possibilidade de participar e criar Projetos Open-source na rede, possibilidade de escrever artigos para o Blog da Impulso, possibilidade de candidatar-se a oportunidades e livre acesso ao meu sistema de recompensas! Além disso, agora você tem acesso ao *Clube de Benefícios Ferro!*
    ...
    levelTwo: `*Parabéns @${username}!* Você completou sua primeira missão, que incrível! :clap: Estou muito animada com seu crescimento! Por isso, você acaba de receber o acesso ao *Clube de Benefícios Bronze!*
    ...
    Então, vou te dar mais uma :dart:*missão!*
    ...
    Já estou ansiosa, viu? Até breve então! :wave:
    Uau, parabéns! :tada: Você acaba de alcançar o *Nível Bronze*;
    *Com isso, você ganhou:* Acesso  ao *Clube de Benefícios Bronze*, disponível no painel em app.impulso.network!`,
    levelThree: `*Olá @${username}, que bom te encontrar de novo!* :blush:
    Você cumpriu sua missão mais uma vez! :muscle: Como foi a experiência? Espero que tenha curtido!
    Enfim, vamos direto ao ponto: agora você conquistou o *Nível Prata* e todos os benefícios que isso traz! :clap:
    Estou empolgada em te dizer que, a partir de agora, você tem acesso ao nosso *Clube de Benefícios Prata!* :tada:
    Além dos benefícios aos quais você já tinha acesso, você também passa a ter direito a *Cashback* :moneybag: em diversas lojas, como Netshoes, Amazon, Kabum, Carrefour e muito mais!
    ...
    Mas como toda conquista traz um novo desafio, quero te deixar com mais uma :dart:*missão*, além do desafio de atingir a quantidade de pontos de Reputação para chegar ao próximo nível!
    Dessa vez, vou deixar você escolher. Você pode:
    - Indicar alguém para a Impulso Network pelo seu :point_right: *link de Referral* que está no painel em app.impulso.network. Basta que a pessoa indicada se inscreva pelo seu link e prontinho!
   ...
   levelFour: `Olá, quanto tempo! :blush:
    ...
    Como recompensa, a partir de agora, você terá acesso ao *Clube de Benefícios Ouro*! :scream:
    Nessa categoria, você entra para o :hospital: *Farmaclube* - o que significa que você terá *descontos em inúmeras redes de farmácias*, com milhares de drogarias espalhadas por todo o Brasil!
    ...
    Veja o tamanho da sua evolução na Impulso Network: *você finalmente venceu sua última :dart: missão*! Por seu trabalho incomparável, você chegou ao *nível mais alto da nossa plataforma!* :trophy:
    Agora, vamos conceder a você a maior honra diante de todos os impulsers: você atingiu o *Nível Diamante* na Impulso Network! :clap:
    Com isso, você terá acesso a todas as recompensas que podemos te oferecer!
    Agora, você terá acesso ao *Clube de Benefícios Diamante!* :gem: Com isso, você passa a ter *acesso gratuito completo por três meses a todos os cursos da Pluralsight*, uma das maiores plataformas mundiais de treinamentos para desenvolvedores!
    ...
    Uau, parabéns! :tada: Você acaba de alcançar o *Nível Diamante;*
    *Com isso, você ganhou:* direito ao *Clube de Benefícios Diamante* e à plataforma PluralSight por três meses, solicitando pelo link impulser.me/resgatar-beneficio.
